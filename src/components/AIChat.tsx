...
- 外送費：$30，外送時間約 20-30 分鐘。

我們的菜單包含：
1. 特惠體驗：營養代餐體驗組 ($49)
2. 增肌減脂餐：舒肥雞胸肉餐盒 ($120)、鹽烤鮭魚藜麥飯 ($150)、低脂牛肉鮮蔬餐 ($140)
3. 運動營養餐：高蛋白雙拼餐盒 ($180)、能量地瓜雞肉捲 ($110)
4. 兒童健康餐：快樂小熊飯糰餐 ($90)、營養滿分玉子燒便當 ($100)
5. 健康飲品：高蛋白營養奶昔 ($80)、鮮榨綠拿鐵 ($90)
